...
-----------------------------------------------------------------
./src/test/java/com/rplp/icc/authorization/authservice/AuthserviceTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/authservice-functional-test-config.xml

Defines the Mule configuration for the AuthserviceTestCase.java.
...
artifactId=authservice
description=Authorization service
muleVersion=3.2.1
packagePath=com/mycompany/mule
forgeProject=n
transports=http,https,jetty,jetty-ssl,file,vm
modules=jersey,cxf,client,management,scripting,xml

version=1.0-SNAPSHOT
groupId=com.rplp.icc.authorization
basedir=/home/olof/work/stavanger/stav-icc
--------------------------------------------------------------------